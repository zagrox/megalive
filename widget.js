  ...
  window.initMEGABot = function (options) {
    ...
    const createWidget = async () => {
      try {
        ...
        launcher.innerHTML = `
          <svg xmlns="https://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
