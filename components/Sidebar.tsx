...
import { Settings, Palette, Database, Rocket, Box, ChevronLeft, LayoutDashboard, Puzzle, User } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  const menuItems: { id: TabType; label: string; icon: React.ReactNode }[] = [
    ...
    { id: 'deploy', label: 'انتشار انلاین', icon: <Rocket size={20} /> },
    { id: 'profile', label: 'حساب کاربری', icon: <User size={20} /> },
  ];
  ...
  return (
    ...
    `}>
      ...
      {/* Header */}
      <div className={`p-4 flex items-center gap-4 border-b border-gray-100 dark:border-gray-800 h-20 ${isCollapsed ? 'justify-center' : ''}`}>
        {appLogoUrl ? (
