...
const GeneralSettings: React.FC<Props> = ({ config, setConfig }) => {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <div>
        <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-2">تنظیمات عمومی</h2>
        <p className="text-gray-500 dark:text-gray-400">اطلاعات پایه و هویت چت‌بات خود را تنظیم کنید.</p>
      </div>
